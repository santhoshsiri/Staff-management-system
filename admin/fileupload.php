...
$salary=$_POST['salary'];
 if($fid!=''&& $fname!=''&& $dob!='' && $designation!='' && $qualification!='' && $salary!='' )
  {
$sql="INSERT INTO faculty(fid,fname,department,dob,designation,qualification,salary) VALUES('$fid','$fname','$department','$dob','$designation','$qualification','$salary')";
        if($result=mysql_query($sql))
          ...
          {
            echo "<script>alert('faculty id already exist')</script>";
                            echo "<script>location.href='upload.php'</script>"; 
          }
          $sql="INSERT INTO uploads(fid) VALUES('$fid')";
          if($result=mysql_query($sql))
            {
          ...
          else
          {
           ...
           $sql="INSERT INTO publications (fid) VALUES('$fid')";
                    if($result=mysql_query($sql))
                      {
